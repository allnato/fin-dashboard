          ...
          <div class="container-fluid">
            ...
            data-show-header="false">
              ...
              <tbody>
                <tr>
                  <td class="list-head">
                      <div class="logo-circle hidden-sm hidden-xs">J</div>
                      <div class="org-acro">JPIA</div>
                  </td>
                  <td class="list-prs">
                    <span style="font-style: italic">PRS: </span>
                    <span style="font-weight: bold">123456789</span>
                  </td>
                  <td class="list-body">
                ...
                <tr>
                  <td class="list-head">
                      <div class="logo-circle hidden-sm hidden-xs">M</div>
                      <div class="org-acro">Math Circle</div>
                  </td>
                  <td class="list-prs">
                    <span style="font-style: italic">PRS: </span>
                    <span style="font-weight: bold">768472657</span>
                  </td>
                  <td class="list-body">
                    <span class="list-title">Battle of the Bands</span>
                    <span class="list-desc">Battle of the Bands hosted in Vito Cruz</span>
                  </td>
                  <td class="list-date">
                    Sep 20 19:21
                  </td>
                ...
                <tr>
                  <td class="list-head">
                      <div class="logo-circle hidden-sm hidden-xs">T</div>
                      <div class="org-acro">TEAMCOMM</div>
                  </td>
                  <td class="list-prs">
                    <span style="font-style: italic">PRS: </span>
                    <span style="font-weight: bold">678723958</span>
                  </td>
                  <td class="list-body">
                    <span class="list-title">T-Shirt Selling</span>
                    <span class="list-desc">New TEAMCOMM T-Shirt</span>
                  </td>
                  <td class="list-date">
                    Oct 31 7:04
                  </td>
